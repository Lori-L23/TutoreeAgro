...
const DEFAULT_IMAGES = {
  fruits: "https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=400&h=300&fit=crop",
  epices: "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=400&h=300&fit=crop",
  cacao: "https://images.unsplash.com/photo-1511381939415-e44015466834?w=400&h=300&fit=crop",
  cereales: "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=400&h=300&fit=crop",
  miel: "https://images.unsplash.com/photo-1558642452-9d2a7deb7f62?w=400&h=300&fit=crop",
  sauces: "https://images.unsplash.com/photo-1596909190503-90dc2c4aaa92?w=400&h=300&fit=crop",
...
const ImageWithFallback = ({ src, alt, className, fallbackKey = "default" }) => {
    ...
    return [
      {
        id: 1,
        name: "Fruits du Pays",
        logo: DEFAULT_IMAGES.fruits,
        cover: DEFAULT_IMAGES.fruits,
      ...
      },
      {
        ...
        logo: DEFAULT_IMAGES.epices,
        cover: DEFAULT_IMAGES.epices,
        description:
          "Production et commercialisation d'épices traditionnelles camerounaises cultivées de manière durable.",
        products: 8,
        region: "Ouest",
        ville: "Bafoussam",
      ...
      },
      {
        ...
        logo: DEFAULT_IMAGES.miel,
        cover: DEFAULT_IMAGES.miel,
        description:
          "Coopérative d'apiculteurs produisant du miel et produits dérivés selon des méthodes respectueuses de l'environnement.",
        products: 5,
        region: "Adamaoua",
        ville: "Ngaoundéré",
      ...
      },
      {
        ...
        logo: DEFAULT_IMAGES.cacao,
        cover: DEFAULT_IMAGES.cacao,
        description:
          "Transformation du cacao en poudre, chocolat et produits dérivés. Fournisseur privilégié des pâtissiers professionnels.",
        products: 10,
        region: "Centre",
        ville: "Yaoundé",
      ...
      },
      {
        ...
        logo: DEFAULT_IMAGES.sauces,
        cover: DEFAULT_IMAGES.sauces,
        description:
          "Production artisanale de sauces et condiments typiquement camerounais, inspirés des recettes traditionnelles.",
        products: 15,
        region: "Centre",
        ville: "Yaoundé",
      ...
      },
      {
        ...
        logo: DEFAULT_IMAGES.cereales,
        cover: DEFAULT_IMAGES.cereales,
        description:
          "Transformation des céréales locales en farines et produits dérivés. Spécialiste du manioc et du maïs.",
        products: 7,
        region: "Sud",
        ville: "Ebolowa",
...
export default function Entreprises() {
  ...
  useEffect(() => {
    const loadInitialData = async () => {
      setLoading(true)
      try {
        const [regionsData, categoriesData, certificationsData] = await Promise.all([
        ...
        setError("Erreur de connexion à l'API. Utilisation des données par défaut.")
  ...
  const loadEnterprises = async (filters = {}) => {
    try {
      const response = await EnterpriseService.fetchEnterprises({
        search: searchTerm,
        region: activeFilters.find((f) => f.startsWith("region-"))?.replace("region-", ""),
        category: activeFilters.find((f) => f.startsWith("cat-"))?.replace("cat-", ""),
        certification: activeFilters.find((f) => f.startsWith("cert-"))?.replace("cert-", ""),
        sort: sortBy,
        page: currentPage,
        ...filters,
      })
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-green-700 to-green-600 text-white py-12 md:py-16 ">
        <div className="container mx-auto px-4 mt-16">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Annuaire des Entreprises Agroalimentaires</h1>
          <p className="text-lg md:text-xl max-w-2xl">
            Découvrez les entreprises camerounaises qui valorisent les ressources locales et contribuent à l'économie
            nationale.
          </p>
              ...
              <div className="space-y-2">
                {regions.map((region, index) => (
                  <div key={index} className="flex items-center">
                    ...
                    />
                    <label htmlFor={`reg-${index}`} className="text-sm flex justify-between w-full cursor-pointer">
              ...
              <div className="space-y-2">
                {categories.map((category, index) => (
                  <div key={index} className="flex items-center">
                    ...
                    />
                    <label htmlFor={`cat-${index}`} className="text-sm flex justify-between w-full cursor-pointer">
              ...
              <div className="space-y-2">
                {certifications.map((cert, index) => (
                  <div key={index} className="flex items-center">
                    ...
                    />
                    <label htmlFor={`cert-${index}`} className="text-sm flex justify-between w-full cursor-pointer">
                      <span>{cert.name}</span>
            ...
            {filteredEnterprises.length > 0 ? (
              ...
              >
                {filteredEnterprises.map((enterprise) => (
                  <EnterpriseCard key={enterprise.id} enterprise={enterprise} viewMode={viewMode} />
                ))}
              </div>
            ) : (
                      ...
                      return (
                        <button
                          ...
                          className={`px-3 py-1 rounded-md ${
                            currentPage === pageNum ? "bg-green-600 text-white" : "text-gray-500 hover:bg-gray-100"
                          }`}
                        >
                          {pageNum}
                        </button>
      ...
      {typeof window !== "undefined" && window.location.hash.startsWith("#enterprise-") && (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-gray-500 bg-opacity-75 transition-opacity">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl">
              ...
              {(() => {
                const enterpriseId = Number.parseInt(window.location.hash.replace("#enterprise-", ""))
                  ...
                  return (
                    <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                      <div className="text-center">
                        ...
                        <h3 className="mt-3 text-lg font-medium text-gray-900">Entreprise non trouvée</h3>
                      </div>
                    </div>
                  )
                          ...
                          <div className="mt-16 pl-2">
                            <div className="flex justify-between items-start">
                              <div>
                                ...
                                <p className="text-gray-500">{enterprise.category}</p>
                              </div>
                            ...
                            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                              <div>
                                ...
                                <p className="text-gray-600">{enterprise.products} produits référencés</p>
                              </div>
                              ...
                              <div>
                                ...
                                <div className="space-y-1">
                                  <div className="flex items-center text-gray-600">
                                    ...
                                    <a href={`mailto:${enterprise.contact.email}`} className="hover:text-green-700">
                                  ...
                                  <div className="flex items-center text-gray-600">
                                    ...
                                    <a
                                      href={`tel:${enterprise.contact.phone.replace(/\s/g, "")}`}
