    ...
    <div className="bg-white text-gray-800">
      ...
      >
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            Découvrez notre mission pour promouvoir les produits agroalimentaires "Made in Cameroon"
          </motion.p>
        </div>
      </motion.section>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              Notre plateforme vise à mettre en lumière les producteurs locaux, les transformateurs et distributeurs
              camerounais en valorisant leurs produits agroalimentaires. Nous voulons offrir une vitrine digitale qui
              connecte les consommateurs aux artisans du terroir camerounais.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              Faire du "Made in Cameroon" une référence de qualité, durable et accessible dans le monde entier.
              Nous croyons en l'innovation locale, la souveraineté alimentaire et la richesse du patrimoine agricole du Cameroun.
            </p>
          </motion.div>
        </div>
      </Section>
      ...
      <Section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            >
              <p className="text-3xl font-bold text-green-700 mb-2">{item.number}</p>
      ...
      <Section className="bg-gradient-to-r from-green-600 to-green-700 text-white">
        ...
        >
          ...
          <p className="text-green-100 mb-8 max-w-xl mx-auto text-lg">
            Que vous soyez producteur, entreprise ou consommateur, engagez-vous à soutenir l'économie locale.
          </p>
          <motion.a
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            href="/inscription"
            className="inline-flex items-center bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-3 px-8 rounded-lg transition shadow-md"
          >
